...
- `basins.py` — `basin_capture_predicate` (runtime), `detect_tail_cycle` (post-hoc structural cycle finder, lifted from the predicate), `BasinSignature` (period, repetitions, late-window entropy/gap, cycle text, cycle token-ids).
