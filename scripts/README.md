...
- **Regime-tag consolidation** (next code pass; planning in `notes/regime-tag-consolidation.md`) — `peirce/regime.py` module + audit script, lifting `first_batch_branches.BATCH`'s manifest column into a function-from-substrate. Prerequisite for the inference extensions below.
